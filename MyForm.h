...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label6->Text = L"√раницы отрезка";
			// 
			// button3
			// 
			...
			this->label5->Text = L" оличество отрезков";
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	private: double searh_En(float& a, double& p)// поиск мат.ожидани€
	{
		double En;
...
private: System::Void button1_Click_1(System::Object^ sender, System::EventArgs^ e) {
	...
	double* arr = new double[n];
	 double temp;
	double S; // выборочна€ дисперси€ 
	double R;//размах выборки 
	double D = 0; // ћера расхождени€
	double max = 0;
	int count = 0;
	...
	*/
	...
	this->dataGridView2->Rows[0]->Cells[4]->Value = S; //выборочна€ дисперси€
